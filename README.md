...
A to-do list app built with React. This is a rebuild of my [vanilla JavaScript version](https://github.com/jameschibueze25-ux/to-do-list-javascript) — same idea, different approach.
